function value = ShekelsFoxholes(option,x,D)
%   Implement the Shekel's Foxholes function 
...
%           - D: The data of the function.
        ...
        for i = 1:n
            for j = 1:30
                ...
                value(1,i) = value(1,i) + 2*(x(i)-a(j,i))/((c(j) + sum)^2);
            end
        end
...
%           - D: Not applicable (no meaning).
        ...
        c = [0.806 0.517 0.100 0.908 0.965 0.669 0.524 0.902 0.531 0.876 0.462 0.491 0.463 0.714 0.352 0.869 0.813 0.811 0.828 0.964 0.789 0.360 0.369 0.992 0.332 0.817 0.632 0.883 0.608 0.326];
        value = {c,a};
