function hl = data_profile(H,N,gate,dic)
...
%     Jorge More' and Stefan Wild. January 2008.
    ...
    %xlim([0 500])
    %title( "tau = 10^-^3"+sprintf('%.6f',gate) );
    title( "Data profile with $\tau$ = "+double(gate),'Interpreter','latex');
    xlabel("# of function evaluations",'Interpreter','latex');
