function value = Bohachevsky1(option,x,D)
%   Implement the Bohachevsky 1 function 
...
%           - D: The data of the function.
        ...
        value = x(1)^2 + 2*x(2)^2 - 0.3*cos(3*pi*x(1)) - 0.4*cos(4*pi*x(2)) + 0.7;
...
%           - D: The data of the function.
        ...
        value = zeros(1,2);
        value(1) = 2*x(1) + 0.9*pi*sin(3*pi*x(1));
        value(2) = 4*x(2) + 1.6*pi*sin(4*pi*x(2));
